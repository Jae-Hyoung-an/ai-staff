...
| 2026-08-04 | @jaehyoung.an | **v1.4** — 메뉴·역할 재편(권역 관리 / 요금 상품 관리 / 벤더 정책 관리). 원가 요금제·벤더 배송권역 독립 메뉴. 원가 할증은 원가 요금제에서만 선택. 세트분배 축=벤더 배송권역. 권역 외 할증=정액·판가 미반영(TBD-5 해소). 권역 시각화=`권역 관리` 하위(TBD-6 해소). D3·D18·D20 대체. 영업존 배송 반경 제거. **멀티팀 리뷰 트랙 A~D** 구조 |
