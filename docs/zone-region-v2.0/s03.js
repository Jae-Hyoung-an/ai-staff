...
S.pt = {
  ...
  + `</div>`
  + `</div></div>`
  + `<div class="foot"${note(11)}><span><b>같은 권역을 04 지점 권역 관리에서도 고치 수 있다</b> — 중첩 검사를 두 곳에 똑같이 두어야 한다 (PT-10 · 13 C-1)</span><span><b>저장 사유</b> 10번 SCR_SET_004와 같은 모달로 받는다</span>${mk(11)}</div>`;}
};
