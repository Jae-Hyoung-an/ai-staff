...
S.ven2 = {
  ...
  notes:[
    ...
    {t:"연결이 없으면 배너를 띄우다", d:"<span class='kbd'>이 벤더는 어느 배송권역에도 연결되어 있지 않아, 소속 기사가 오더를 받지 못합니다.</span> 등록은 됐지만 <b>기사가 지점에 배치된 채 오더를 못 받는 상태</b>임을 이 자리에서 알린다.", r:"11 §4.3 섹션4 · VEN-7"},
