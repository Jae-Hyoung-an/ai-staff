...
S.ven2 = {
  ...
  + plain({title:"저장 흐름",tag:"신설",tagk:"new"}, `<div class="body">
      ...
      <div class="hint" style="margin-top:10px">09 · 10 · 11이 <b>같은 저장 · 이력 구조</b>를 쓴다 (루트 「공통 규칙 — 저장과 변경 이력」). 사유는 <b>공란을 허용하지 않는다.</b> 11에는 조건부 고지 모달이 없어 사유 입력 한 단계뿐이다 — <b>예약 저장도 없다.</b></div>
    </div>`)
