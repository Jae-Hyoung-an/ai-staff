...
S.vp2 = {
  ...
  notes:[
    ...
    {t:"비활성화 기사 표도 같이 바뀜다", d:"아래쪽 <b>비활성화 기사 표</b>는 활성 기사 표와 <b>컬럼 구성이 같다.</b> 한쪽만 고치면 표 둘의 모양이 어긋난다.", r:"12 §4.3"},
...
S.vp3 = {
  ...
  notes:[
    ...
    {t:"기준은 실시간과 같다", d:"<span class='kbd'>수락 전 취소</span>에서 권역 외 · 회귀를 벘다. <b>네 곳이 전부 같은 기준</b>이어야 한다 — 대시보드 · 실시간 활성 · 실시간 비활성 · 주간.", r:"12 VP-4"},
