S.vdr2 = {
  ...
  notes:[
    ...
    {t:"차단 기준이 지점으로 바뀜다", d:"「사용 중인 공급권역」이 아니라 「이미 배송권역이 있는 지점」을 지점 선택 목록에서 막는다. 지점 : 배송권역 = 1:1이다.", r:"03 VDR-4 · 검사 3 · 2026-09-01"},
  ...
  + plain({title:"지도",tag:"조회 전용",mk:5,axis:"cost"},`<div class="body">${MAP_VDR}
      <div class="maplegend"><span><i style="background:var(--cost)"></i>이 배송권역</span><span><i style="background:var(--line-2)"></i>다른 배송권역</span><span><i style="background:var(--sales);opacity:.45"></i>영업존 (겹쳤 보기)</span><span><i style="background:var(--warn-bg);border:1px dashed var(--warn)"></i>어느 권역에도 없는 지역</span></div>
  ...
  + plain({title:"이력",tag:"신규",actions:[{t:"삭제"},{t:"목록으로"},{t:"저장",pri:1}]},
      tbl([{t:"일시",mono:1},{t:"바뀐 것"},{t:"왜 남기나"}],[
        ...
        ["2026-07-30 16:44","연결 정책 <span class='strike'>서울 북부 임시</span> → <b>서울 북부 A</b>","정책이 바뀌면 원가 요금제가 바뀜다"],
