...
S.vis = {
  ...
  + card({title:"CM · CMR 표시",tag:"P1 · 초기 범위 제외",tagk:"mute",mk:5},
      `<div class="hint" style="margin:0">폴리곱별 최근 1주 CM·CMR과 하한선 이탈 여부를 색으로 덦입힌다. <b>집계 기준과 하한선이 정해지지 않아</b> 초기 범위에서 제외한다. 이것이 없는 동안에는 권역을 만들고 나서 그 권역이 잘 돌아가는지를 이 화면에서 알 수 없다.</div>`);}
};
