...
S.vdr = {
  ...
  notes:[
    {t:"독립 메뉴로 승격", d:"정책 화면 안의 탭이던 것을 독립 메뉴로 분리한다. 이 권역이 원가·정산·세트분배·벤더 소속의 기준 축이다.", r:"03 §2"},
    ...
    {t:"빠진 연결을 걸러 본다", d:"정책이나 벤더가 붙지 않은 권역은 배차에 쓰이지 않는데 화면에는 정상으로 보인다. 상단 칩으로 그 행만 걸러낸다.", r:"03 §5.1"},
