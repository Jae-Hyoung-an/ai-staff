...
S.ez = {
  ...
  notes:[
    ...
    {t:"세일즈 권역 표시", d:"어떤 권역에 판가가 걸려 있는지 목록에서 바로 보이게 한다. 용어는 세일즈 권역으로 통일했다.", r:"00 §5.1 · 02 §5.1"},
    {t:"판가 요금제 표시", d:"요금제 쪽 목록의 대상 존 수가 0으로 보이는 결함 때문에 존 쪽에서 대신 보여준다. 연결이 없으면 강조한다.", r:"02 §5.1"},
