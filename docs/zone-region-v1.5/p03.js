...
S.ez2 = {
  ...
  notes:[
    ...
    {t:"이력 신설", d:"어떤 세일즈 권역이 연결되었다 바뀌었는지를 남긴다. 판가가 어떤 권역에 적용됐는지를 되짚는 근거다.", r:"02 §5.2 섹션4"}
  ],
  render(){ return head({h:"영업존 등록",p:"지점을 고르고 그 지점의 세일즈 권역 하나를 고르면 끕이다. 금액은 <b>판가 요금제 관리</b>에서 정한다.",owner:"영업 담당자",review:"권역 서버 담당 팀"})
